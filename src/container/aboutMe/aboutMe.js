...
import img from "../../assets/Remember_1.jpeg";
import { AboutMe } from "../../components";
import { DownloadCVButton } from "../../components/buttons";
import cv from "../../assets/cv/remember.pdf";
import letter from "../../assets/cv/Remember_letter.pdf";
    ...
    <AboutMe>
      <AboutMe.Container>
        ...
        <AboutMe.Column>
          ...
          <AboutMe.Heading4>Hello! My Name is Remember Nduma.</AboutMe.Heading4>
          <AboutMe.Text>
